...
epochs = 10
# number of times to run non-GA and GA algorithm to get avg accuracies
...
def main():
    ...
    print "Grand mean of neural net using entire feature string, across runs of epochs:", grand_mean
